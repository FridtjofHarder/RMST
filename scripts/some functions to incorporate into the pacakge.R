...
#test wieder löschen
armC <- create_arm(size = 40, accr_time = 0.00001, surv_scale = 1, loss_scale = 0.0000001,
                   total_time = 10)
armE <- create_arm(size = 40, accr_time = 0.00001, surv_scale = 1.2, loss_scale = 0.000001,
                   total_time = 10)
